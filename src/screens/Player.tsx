  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Pre-flight probe: ask the service to walk redirects + read the
        // first 64 KB of each top candidate, identifying the container and
        // catching DTS/TrueHD audio that the TV cannot decode. Filter the
        // bad ones out BEFORE the native pipeline ever sees them, so the
        // user never sits through the 20 s hang detector waiting for the
